...
//for admin
    ...
    axios.get('https://westview-lms-mern.herokuapp.com/users/').then(
      (res)=>{
...
//for student
    ...
    axios.get('https://westview-lms-mern.herokuapp.com/students/').then(
      (res)=>{
        console.log(res.data)
        setStuname(
      ...
      axios.get('https://westview-lms-mern.herokuapp.com/teachers/').then(
      (res)=>{
        console.log(res.data)
        setTeachname(
